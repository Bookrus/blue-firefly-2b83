...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/blue-firefly-2b83#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/blue-firefly-2b83
```

A live public deployment of this template is available at [https://blue-firefly-2b83.templates.workers.dev](https://blue-firefly-2b83.templates.workers.dev)
